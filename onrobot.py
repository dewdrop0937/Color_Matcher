# Robotiq RG2 / RG6 Gripper Control Module
# - Modbus TCP 통신을 사용하여 Robotiq RG2 / RG6 그리퍼를 제어
# - 그리퍼 연결/해제 및 상태(Status) 조회 기능 제공
# - 그리퍼 폭(width), 힘(force), 제어 모드 설정 지원
# - 열기(Open), 닫기(Close), 지정 폭 이동(Move) 명령을 추상화한 제어 클래스
# - 로봇 매니퓰레이터 시스템에서 말단 그리퍼 제어용으로 사용
